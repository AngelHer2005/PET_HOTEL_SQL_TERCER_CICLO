...
('T001', 0, 1, 'Tratamiento antipulgas y desparasitación mensual', 'Producto utilizado: XWY'),
('T002', 0, 1, 'Desparasitación mensual', 'Producto utilizado: HCC'),
('T003', 1, 0, 'Tratamiento antipulgas mensual', 'Producto utilizado: DPF'),
('T004', 0, 0, 'Sin tratamiento', 'No se aplicaron tratamientos este mes'),
('T005', 1, 1, 'Tratamiento antipulgas y desparasitación quincenal', 'Producto utilizado: LNW');
GO
...
('C001', 'Juan', 'Pérez', '12345678', '987654321', 'Calle Ayacucho #324, Lima', 'F001'),
('C002', 'María', 'Gómez', '87654321', '654321987', 'Avenida Cajamarca #942, Santa Rosa', 'F002'),
('C003', 'Carlos', 'Rodríguez', '56789012', '321987654', 'Calle San José #524, Callao', 'F003'),
('C004', 'Laura', 'Hernández', '34567890', '789012345', 'Calle Júpiter #155, Callao', 'F004'),
('C005', 'Javier', 'López', '90123456', '234567890', 'Avenida Quilca #421, Callao', 'F005');
GO

INSERT INTO RESERVA VALUES 
('R001', GETDATE() + 7, 60.00, 'C001', 'CA001'),
('R002', GETDATE() + 10, 80.00, 'C002', 'CA002'),
('R003', GETDATE() + 5, 100.00, 'C003', 'CA003'),
('R004', GETDATE() + 14, 50.00, 'C004', 'CA004'),
('R005', GETDATE() + 8, 75.00, 'C005', 'CA005');
GO
...
('P001', 'Calle Paracas #23, Lima', '995241652', 'Hotel Canino Feliz', 'R001', 'H001'),
('P002', 'Avenida Mayo #521, Arequipa', '988231521', 'Pet Paradise', 'R002', 'H002'),
('P003', 'Calle Quilca #629, Trujillo', '998521340', 'Doggy Haven', 'R003', 'H003'),
('P004', 'Calle Cusco #521, Chiclayo', '994251342', 'Paws Palace', 'R004', 'H004'),
('P005', 'Calle Junín #983, Cusco', '904325145', 'Barkington Hotel', 'R005', 'H005');
GO
